...
def filters_layout():
    controls = [
        ...
        multi_field("filter-rank", "Rank", distinct_values("rank"), "Filter by crew rank (CAP, OFI, EJE, SOB)."),
        multi_field("filter-homebase", "Home base", distinct_values("homebase"), "Filter by the crew member's home base."),
